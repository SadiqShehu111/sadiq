  ...
  return (
    <>
      <div ref={cvRef} className="max-w-4xl mx-auto bg-white text-black p-8 print:p-6 font-serif text-lg">
        ...
        {/* Relevant Projects */}
        <section className="mb-6">
          <h2 className="text-3xl font-bold text-blue-900 border-b border-gray-300 pb-2 mb-4">RELEVANT RESEARCH & PROJECTS</h2>
          ...
          <div className="mb-5">
            <div className="flex justify-between items-start mb-1">
              ...
              <span className="text-base text-gray-800">2023</span>
            </div>
          ...
          <div className="mb-5">
            <div className="flex justify-between items-start mb-1">
              ...
              <span className="text-base text-gray-800">2022</span>
            </div>
            <ul className="list-disc ml-6 text-base space-y-1">
          ...
          <div className="mb-5">
            <div className="flex justify-between items-start mb-1">
              ...
              <span className="text-base text-gray-800">2017 – 2023</span>
            </div>
            <ul className="list-disc ml-6 text-base space-y-1">
          ...
          <div className="mb-5">
            <div className="flex justify-between items-start mb-1">
              ...
              <span className="text-base text-gray-800">2024 – 2025</span>
            </div>
            <ul className="list-disc ml-6 text-base space-y-1">
        ...
        <section className="mb-6">
          <h2 className="text-3xl font-bold text-blue-900 border-b border-gray-300 pb-2 mb-4">PROFESSIONAL EXPERIENCE</h2>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-start mb-2">
              ...
              <span className="text-base text-gray-800">January 2026 – Present</span>
            </div>
            <ul className="list-disc ml-6 text-base space-y-1">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-start mb-2">
              ...
              <span className="text-base text-gray-800">May 2024 – December 2025</span>
            </div>
            <ul className="list-disc ml-6 text-base space-y-1">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-start mb-2">
              ...
              <span className="text-base text-gray-800">2020 – 2022</span>
            </div>
            <ul className="list-disc ml-6 text-base space-y-1">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-start mb-2">
              ...
              <span className="text-base text-gray-800">2015 – 2023</span>
            </div>
            <ul className="list-disc ml-6 text-base space-y-1">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-start mb-2">
              ...
              <span className="text-base text-gray-800">2013 – 2015</span>
            </div>
            <ul className="list-disc ml-6 text-base space-y-1">
        ...
        {/* Education */}
        <section className="mb-6">
          <h2 className="text-3xl font-bold text-blue-900 border-b border-gray-300 pb-2 mb-4">EDUCATION</h2>
          <div className="mb-3">
            <div className="flex justify-between">
              <div>
                ...
                <p className="text-base italic">Thesis: Establishing Secure and Privacy-Preserving Digital Identity with Self-Sovereign Identity</p>
              </div>
              <span className="text-base text-gray-800">2017 – 2023</span>
            </div>
          </div>
          <div className="mb-3">
            <div className="flex justify-between">
              ...
              <span className="text-base text-gray-800">2011 – 2012</span>
            </div>
          </div>
          <div className="mb-3">
            <div className="flex justify-between">
              ...
              <span className="text-base text-gray-800">2007 – 2011</span>
            </div>
          </div>
        </section>
        ...
        <section className="mb-6">
          <h2 className="text-3xl font-bold text-blue-900 border-b border-gray-300 pb-2 mb-4">SELECTED PUBLICATIONS</h2>
