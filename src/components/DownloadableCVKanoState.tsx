  ...
  return (
    <>
      <div ref={cvRef} className="max-w-4xl mx-auto bg-white text-black p-8 print:p-6">
        ...
        {/* Relevant Projects */}
        <section className="mb-6">
          <h2 className="text-xl font-bold text-blue-600 border-b border-gray-300 pb-2 mb-4">RELEVANT RESEARCH & PROJECTS</h2>

          <div className="mb-5">
            <div className="flex justify-between items-start mb-1">
              <div>
                <h3 className="font-bold">SPIDVerify — Decentralised Identity Verification Framework</h3>
                <p className="text-blue-600">Research Lead • University of Porto / INESC TEC</p>
              </div>
          ...
          <div className="mb-5">
            <div className="flex justify-between items-start mb-1">
              <div>
                ...
                <p className="text-blue-600">Co-Team Researcher • INESC TEC Porto (€2.5M EU Horizon 2020)</p>
              </div>
          ...
          <div className="mb-5">
            <div className="flex justify-between items-start mb-1">
              <div>
                ...
                <p className="text-blue-600">Cyber Security Post-Doctoral Research Fellow • University of Surrey (£6M EPSRC programme)</p>
              </div>
        ...
        <section className="mb-6">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-start mb-2">
              ...
              <span className="text-sm text-gray-600">2015 – 2023</span>
            </div>
            <ul className="list-disc ml-6 text-sm space-y-1">
